...
fish_amount = 10
money = 0
rnd1 = 0 #These vars are called so that the variable is defined so you don't get "variable not defined" errors below."
rnd2 = 0
num_killed = 0
...
print("- 8$ at the end of each year will be extracted for living expenses. If get below 0$, you lose!")
